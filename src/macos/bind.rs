...
pub const COPYFILE_STATE_RECURSIVE_SRC_FTSENT: u32 = 17;
pub const COPYFILE_STATE_FORBID_DST_EXISTING_SYMLINKS: u32 = 18;
pub const COPYFILE_DISABLE_VAR: &[u8; 17] = b"COPYFILE_DISABLE\0";
